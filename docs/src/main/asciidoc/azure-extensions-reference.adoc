...
Otherwise, use the `quarkus-azure-functions-http` extension.
|Preview
...
link:https://quarkus.io/guides/funqy[Quarkus Funqy] provides a portable Java API to write functions, mapped to the JAX-RS existing programming model.
...
// What other Quarkus Azure extensions should we document here and
