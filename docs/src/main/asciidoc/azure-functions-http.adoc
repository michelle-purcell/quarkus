...
////
[id="azure-functions-resteasy-tutorial"]
...
// Diataxis: If this section grows, I propose that the following section == is moved into a new reference topic that describes the extensions and is linked from here.
...
You can optionally edit the deployment descriptors as needed, and then rebuild when you are ready.
